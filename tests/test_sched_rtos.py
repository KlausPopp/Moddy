...
class TestSchedRtos(unittest.TestCase):
    def testScheduling(self):
        ...
        class myThread2(moddy.VThread):
            def __init__(self, sim):
                super().__init__(
                    sim=sim, obj_name="lowThreadA", parent_obj=None
                )
        ...
        class myThread3(moddy.VThread):
            def __init__(self, sim):
                super().__init__(
                    sim=sim, obj_name="lowThreadB", parent_obj=None
                )
    ...
    def testQueingPort(self):
        ...
        self.assertEqual(
            searchAnn(trc, 55.0, t1), "['hello1', 'hello2', 'hello3']"
        )
    ...
    def testQueingIOPort(self):
        ...
        self.assertEqual(
            searchAnn(trc, 158.0, t1), "['hello8', 'hello9', 'hello10']"
        )
        ...
        class myThread1(moddy.VThread):
            ...
            def run_vthread(self):
                ...
                while True:
                    ...
                    self.annotation(
                        "D Fired " + str(self.tmr1.has_fired()) + " rv " + rv
                    )
                    self.tmr1.stop()
