...
## [1.4.1] - 2018-11-20
### Fixed
- Interactive Sequence Diagram: Watched variables were not shown if the part containing variable was not shown
- Exception if output files were in current directory (and not in a subdirectory)

## [1.4.0] - 2018-11-19
### Added 
- Sequence Diagram Interactive Viewer: Part boxes can now be moved (dragged) on
